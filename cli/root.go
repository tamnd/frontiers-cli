// Package cli builds the frontiers command tree on top of the frontiers library.
package cli
...
type App struct {
	client *frontiers.Client
	cfg    frontiers.Config
...
func Root() *cobra.Command {
	app := &App{cfg: frontiers.DefaultConfig()}

	root := &cobra.Command{
		Use:           "frontiers",
		Short:         "Browse Frontiers academic journals",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = frontiers.NewClient(a.cfg)
	return nil
}
