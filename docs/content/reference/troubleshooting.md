...
Most of these come down to network reality or how frontiers serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

frontiers rate-limits like any public site. frontiers already paces
...
Where a surface is gated, frontiers reads a cookie or token you supply
...
`frontiers`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what frontiers actually did
